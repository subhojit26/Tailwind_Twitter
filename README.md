This project is for practicing and getting hands on experience with Tailwind CSS. This is a frontend clone of the Twitter application(now called X) using Tailwind CSS. 
